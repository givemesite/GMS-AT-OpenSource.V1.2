...
//user => password
$users = array('admin' => 'JKHKHJH^&*^FF', 'kris' => 'JKHKHJH^&*^FF');
...
<table id="foot" width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
		<th><a href="http://WinNMP.wtriple.com/" title="WinNMP (wt-nmp) development stack"><img src="tools/wtripleLogo48.png" /></a></th>
		...
		<td><a href="http://WinNMP.wtriple.com/" title="WinNMP (wt-nmp) Official Website">WinNMP Docs</a></td>
		...
		<td><a href="http://hosting.wtriple.com/" title="Benefit from the same straightforward aproach of WinNMP (wt-nmp), on our Linux Managed Nginx hosting servers"><b>Nginx Hosting</b></a></td>
		<td>$nginxVersion</td>
